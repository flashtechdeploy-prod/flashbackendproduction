#!/usr/bin/env python3
"""Fixed import tool - Import employee data from JSON file one by one"""
...
def import_employee_json_fixed():
    """Import employee data from JSON file with error handling"""
    try:
        # Read the JSON file
